        ...
        <div class="row row-70 row-ten row-fix justify-content-xl-between">
          <div class="col-xl-3">
            <div class="row row-70 row-fix align-items-md-center">
              <div class="col-md-6 col-xl-12"><img src="images/team-member-1-420x420.jpg" alt="" width="420"
                  height="420" />
              </div>
          ...
          <div class="col-xl-6">
            <div class="row row-120 row-fix">
              <div class="col-sm-12">
                ...
                <p class="text-spacing-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
