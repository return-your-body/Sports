  ...
  <div class="chart-container">
    <div class="chart-row">
      <div class="chart-box">
        ...
        <div id="workChartEmpty" class="text-danger d-none">⚠ 無資料</div>
      </div>
      <div class="chart-box">
        <h5 class="text-center">請假統計（分鐘）</h5>
        <canvas id="leaveChart"></canvas>
        <div id="leaveChartEmpty" class="text-danger d-none">⚠ 無資料</div>
      </div>
    </div>
  </div>
...
function drawCharts(data) {
  ...
  if (data.work?.length) {
    $('#workChart').show();
    $('#workChartEmpty').addClass('d-none');
    ...
    $('#workChart').hide();
    $('#workChartEmpty').removeClass('d-none');
  }

  if (data.leave?.length && data.leave_types?.length) {
    $('#leaveChart').show();
    $('#leaveChartEmpty').addClass('d-none');
    ...
    $('#leaveChart').hide();
    $('#leaveChartEmpty').removeClass('d-none');
  }
}
