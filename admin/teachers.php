    ...
    <section class="section section-lg novi-bg novi-bg-img bg-default">
      <div class="container">
        <div class="row row-40 row-lg-50">
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="team-default box-width-3">
              <div class="team-default-media"><img class="team-default-img" src="images/team-05-260x345.jpg" alt=""
                  width="260" height="345" loading="lazy" />
              </div>
              <h6 class="team-default-title"><a href="single-teacher.php">Michael Johnson</a></h6>
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="team-default box-width-3">
              <div class="team-default-media"><img class="team-default-img" src="images/team-06-260x345.jpg" alt=""
                  width="260" height="345" loading="lazy" />
              </div>
              <h6 class="team-default-title"><a href="single-teacher.php">Emma Adams</a></h6>
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="team-default box-width-3">
              <div class="team-default-media"><img class="team-default-img" src="images/team-07-260x345.jpg" alt=""
                  width="260" height="345" loading="lazy" />
              </div>
              <h6 class="team-default-title"><a href="single-teacher.php">Jack Peters</a></h6>
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="team-default box-width-3">
              ...
              <h6 class="team-default-title"><a href="single-teacher.php">Jane Lee</a></h6>
