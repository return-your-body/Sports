      ...
      <div class="section page-header breadcrumbs-custom-wrap bg-image bg-image-9">
        ...
        <section class="breadcrumbs-custom breadcrumbs-custom-svg">
          <div class="container">
            ...
            <p class="heading-1 breadcrumbs-custom-title">Courses</p>
          ...
          <div class="row row-50 justify-content-md-center justify-content-xl-end justify-content-xxl-end">
            <div class="col-md-9 col-lg-8 col-xl-6 col-xxl-5">
              <div class="box-range-content">
                ...
                <p class="text-spacing-sm">Nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p><a class="button button-primary button-nina" href="about-us.html">learn more</a>
              </div>
            </div>
                  ...
                  <div class="jp-video jp-video-single">
                    <div class="jp-type-playlist">
                      ...
                      <ul class="jp-player-list">
                        <li class="jp-player-list-item" data-jp-m4v="video/video-bg.mp4" data-jp-title="local video" data-jp-poster="video/video-bg.jpg"></li>
                      </ul>
          ...
          <div class="row row-50 justify-content-sm-center text-start">
            <div class="col-sm-10 col-md-6 col-xl-3">
              <article class="box-minimal box-minimal-border">
                ...
                <hr>
                <div class="box-minimal-text">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione.</div>
              </article>
            </div>
            <div class="col-sm-10 col-md-6 col-xl-3">
              <article class="box-minimal box-minimal-border">
                ...
                <hr>
                <div class="box-minimal-text">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa.</div>
              </article>
            </div>
            <div class="col-sm-10 col-md-6 col-xl-3">
              <article class="box-minimal box-minimal-border">
                ...
                <hr>
                <div class="box-minimal-text">Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi.</div>
              </article>
            </div>
            <div class="col-sm-10 col-md-6 col-xl-3">
              <article class="box-minimal box-minimal-border">
                ...
                <hr>
                <div class="box-minimal-text">Dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit labori.</div>
              </article>
            </div>
          </div>
        </div>
      ...
      <section class="section section-wrap section-wrap-equal">
        <div class="section-wrap-inner">
          <div class="container container-bigger">
            <div class="row row-fix row-ten justify-content-md-center justify-content-lg-start justify-content-xl-between">
              <div class="col-md-8 col-lg-4">
                <div class="section-lg">
                  <h3>Development of your business skills</h3>
                  <div class="divider divider-default"></div>
                  <p>Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur fugiat quo.</p><a class="button button-primary button-nina" href="single-course.html">Learn more</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row row-fix row-ten justify-content-md-center justify-content-lg-start justify-content-lg-end">
              <div class="col-md-8 col-lg-4">
                <div class="section-lg">
                  ...
                  <div class="divider divider-default"></div>
                  <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati.</p><a class="button button-primary button-nina" href="single-course.html">Learn more</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row row-fix row-ten justify-content-md-center justify-content-lg-start justify-content-xl-between">
              <div class="col-md-8 col-lg-4">
                <div class="section-lg">
                  ...
                  <div class="divider divider-default"></div>
                  <p>Non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio. Nam libero.</p><a class="button button-primary button-nina" href="single-course.html">Learn more</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row row-ten justify-content-md-center justify-content-lg-start justify-content-lg-end">
              <div class="col-md-8 col-lg-4">
                <div class="section-lg">
                  ...
                  <div class="divider divider-default"></div>
                  <p>Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae. Itaque earum rerum hic.</p><a class="button button-primary button-nina" href="single-course.html">Learn more</a>
                </div>
              </div>
            </div>
          </div>
