  ...
  <div class="page">
    ...
    <section class="section section-xl bg-image bg-image-9 text-center novi-bg novi-bg-img">
      <div class="container">
        ...
        <p class="big">Want to get professional knowledge in the fast-developing IT sphere? Pract offers a wide variety
      ...
      <div class="container">
        <div class="row row-30 align-items-center justify-content-xxl-between">
          <div class="col-md-6">
            ...
            <p class="big">Every member of Pract team believes strongly in the empowering power of knowledge. And we aim
            ...
            <div class="row row-30 row-offset-1">
              <div class="col-md-10 offset-xxl-2">
                <div class="box-small">
                  ...
                  <div class="box-small-text">Pract involves the best industry leaders, who share their experience,
                    knowledge and tips with our students.</div>
                </div>
                <div class="box-small">
                  <h5 class="box-small-title">Best teachers</h5>
                  <div class="box-small-text">Our staff consists of professional experienced teachers, who love what
                    they do and use creative approach in teaching.</div>
                </div>
                <div class="box-small">
                  <h5 class="box-small-title">National awards</h5>
                  <div class="box-small-text">Pract takes part in many IT educational contests. We won the National IT
        ...
        <div class="row row-30 justify-content-md-between align-items-center">
          <div class="col-md-5 position-relative d-none d-md-block">
            <div class="parallax-scene-js parallax-scene parallax-scene-2" data-scalar-x="5" data-scalar-y="10">
              <div class="layer-01">
                <div class="layer" data-depth="0.25"><img src="images/home-17-460x580.jpg" alt="" width="460"
                    height="580" loading="lazy" />
                </div>
              </div>
              <div class="layer-02">
                <div class="layer" data-depth=".55"><img src="images/home-18-260x355.jpg" alt="" width="260"
        ...
        <div class="row row-40 row-lg-50">
          <div class="col-sm-6 col-lg-3 wow fadeInLeft" data-wow-delay=".2s">
            <div class="team-default box-width-3">
              <div class="team-default-media"><img class="team-default-img" src="images/home-10-260x345.jpg" alt=""
                  width="260" height="345" loading="lazy" />
              </div>
              <h6 class="team-default-title"><a href="single-teacher.php">Theresa Webb</a></h6>
          ...
          <div class="col-sm-6 col-lg-3 wow fadeInLeft">
            <div class="team-default box-width-3">
              <div class="team-default-media"><img class="team-default-img" src="images/home-11-260x345.jpg" alt=""
                  width="260" height="345" loading="lazy" />
              </div>
              <h6 class="team-default-title"><a href="single-teacher.php">Jenny Wilson</a></h6>
          ...
          <div class="col-sm-6 col-lg-3 wow fadeInRight">
            <div class="team-default box-width-3">
              <div class="team-default-media"><img class="team-default-img" src="images/home-12-260x345.jpg" alt=""
                  width="260" height="345" loading="lazy" />
              </div>
              <h6 class="team-default-title"><a href="single-teacher.php">Jacob Jones</a></h6>
          ...
          <div class="col-sm-6 col-lg-3 wow fadeInRight" data-wow-delay=".2s">
            <div class="team-default box-width-3">
              <div class="team-default-media"><img class="team-default-img" src="images/home-13-260x345.jpg" alt=""
                  width="260" height="345" loading="lazy" />
              </div>
              <h6 class="team-default-title"><a href="single-teacher.php">Bessie Cooper</a></h6>
        ...
        <div class="row">
          <div class="col-xl-11">
            <div class="box-cta box-cta-inline">
              ...
              <div class="box-cta-inner"><a class="button button-dark button-nina" href="contacts.php">Contact us</a>
              </div>
            </div>
          </div>
        </div>
