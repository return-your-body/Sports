            ...
            <div class="rd-navbar-inner">
              ...
              <div class="rd-navbar-nav-wrap">
                <ul class="rd-navbar-nav">
                  <li class="rd-nav-item active"><a class="rd-nav-link" href="index.html">網頁編輯</a>
                  </li>
                  <li class="rd-nav-item"><a class="rd-nav-link" href="about-us.html">治療師時間表</a>
                  </li>
                  <li class="rd-nav-item"><a class="rd-nav-link" href="teachers.html">新增診療項目</a>
                    <ul class="rd-menu rd-navbar-dropdown">
                      <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="single-teacher.html">Single teacher</a>
                      </li>
                    </ul>
                  </li>
                  <li class="rd-nav-item"><a class="rd-nav-link" href="courses.html">病患資料</a>
                    <ul class="rd-menu rd-navbar-dropdown">
                      <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="single-course.html">黑名單</a>
                      </li>
                    </ul>
                  </li>
