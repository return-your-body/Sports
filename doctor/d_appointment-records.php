...
<body>
  ...
  <div class="page">
    ...
    // 確認登入的醫生帳號並取得 doctor_id
    if (!isset($_SESSION['doctor_id'])) {
      echo "<script>alert('未登入，請重新登入！'); window.location.href = 'login.php';</script>";
      exit;
    }

    $doctor_id = $_SESSION['doctor_id']; // 當前登入醫生的 ID
    ...
    $count_sql = "SELECT COUNT(*) AS total 
              ...
              WHERE ds.doctor_id = '$doctor_id' AND p.name LIKE '%$search_name%'";
    ...
    $sql = "SELECT 
        ...
        WHERE 
            ds.doctor_id = '$doctor_id' AND p.name LIKE '%$search_name%'
        ORDER BY 
    ...
    <section class="section section-lg bg-default novi-bg novi-bg-img">
      ...
      <!-- 顯示表格 -->
      <table border="1" style="border-collapse: collapse; width: 100%; table-layout: auto; text-align: center;">
      ...
      <div style='text-align: center; margin-top: 20px;'>
        <p>第 <?php echo $page; ?> 頁，共 <?php echo $total_pages; ?> 頁</p>
        <?php
        if ($page > 1) {
