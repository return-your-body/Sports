	...
	<div class="page">
		...
		<section class="section section-xl bg-image bg-image-9 text-center novi-bg novi-bg-img">
			<div class="container">
				...
				<p class="big">Want to get professional knowledge in the fast-developing IT sphere? Pract offers a wide
					variety
				...
				<div class="row row-40 row-lg-50">
					<div class="col-sm-6 col-md-4 wow fadeInUp" data-wow-delay=".1s">
						<div class="box-project box-width-3">
							...
							<h6 class="box-project-title"><a href="single-course.php">Development of your business
									skills</a></h6>
					...
					<div class="col-sm-6 col-md-4 wow fadeInUp" data-wow-delay=".2s">
						<div class="box-project box-width-3">
							...
							<div class="box-project-subtitle small">Business</div>
							<h6 class="box-project-title"><a href="single-course.php">IT fundamentals for business</a>
							</h6>
							<div class="box-project-meta">
								<div class="box-project-meta-item"><span
										class="box-project-meta-icon linearicons-clock3"></span><span
					...
					<div class="col-sm-6 col-md-4 wow fadeInUp" data-wow-delay=".3s">
						<div class="box-project box-width-3">
							...
							<h6 class="box-project-title"><a href="single-course.php">Online marketing: SEO and SMM</a>
							</h6>
							<div class="box-project-meta">
								<div class="box-project-meta-item"><span
										class="box-project-meta-icon linearicons-clock3"></span><span
				...
				<div class="row row-40 row-lg-50">
					...
					<div class="col-sm-6 col-md-4">
						<div class="list-border">
							...
							<div class="list-border-item">The Complete Networking Fundamentals Course. Your CCNA start
							</div>
							<div class="list-border-item">Linux: SSH to remote server &amp; Networking basics for DevOps
							</div>
							<div class="list-border-item">Build automated speech systems with Azure Cognitive Services
							</div>
					...
					<div class="col-sm-6 col-md-4">
						<div class="list-border">
							...
							<div class="list-border-item">Web Design for Everybody: Basics of Web Development &amp;
								Coding</div>
					...
					<div class="col-xl-11">
						<div class="box-cta box-cta-inline">
							...
							<div class="box-cta-inner"><a class="button button-dark button-nina"
									href="contacts.php">Contact us</a>
							</div>
						</div>
					</div>
				</div>
